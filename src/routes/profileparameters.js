...
const ProfileParameters = React.createFactory(require("../components/examples/profileparameters.jsx"));
...
function renderPage(customizations) {
  return ReactDOMServer.renderToString(React.createElement(ProfileParameters, {customizations}));
}
