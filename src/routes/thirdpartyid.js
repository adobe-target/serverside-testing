...
const ThirdPartyId = React.createFactory(require("../components/examples/thirdpartyid.jsx"));
...
function renderPage(customizations) {
  return ReactDOMServer.renderToString(React.createElement(ThirdPartyId, {customizations}));
}
