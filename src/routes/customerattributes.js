...
const CustomerAttributes = React.createFactory(require("../components/examples/customerattributes.jsx"));
...
function renderPage(customizations) {
  return ReactDOMServer.renderToString(React.createElement(CustomerAttributes, {customizations}));
}
